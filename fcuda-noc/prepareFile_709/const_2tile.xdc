...
create_clock -period 1.500 -name sys_clk_i [get_ports sys_clk_i]
#set_propagated_clock sys_clk_i

create_clock -period 5.000 -name clk_ref_i [get_ports clk_ref_i]
#set_propagated_clock clk_ref_i

create_clock -period 7.000 -name aclk [get_ports aclk]

#create_pblock pblock_1
#resize_pblock pblock_1 -add CLOCKREGION_X0Y0:CLOCKREGION_X1Y4
#add_cells_to_pblock [get_pblocks pblock_1] [get_cells -quiet [list design_1_i/fcuda_core_0 design_1_i/fcuda_core_2 design_1_i/fcuda_core_4]]
 
#create_pblock pblock_2
#resize_pblock pblock_2 -add CLOCKREGION_X0Y5:CLOCKREGION_X1Y9
#add_cells_to_pblock [get_pblocks pblock_2] [get_cells -quiet [list design_1_i/fcuda_core_1 design_1_i/fcuda_core_3 design_1_i/fcuda_core_5]]
...
set_property PACKAGE_PIN G12 [get_ports {ddr3_ba[2]}]
...
set_property PACKAGE_PIN F15 [get_ports {ddr3_ba[0]}]
...
set_property PACKAGE_PIN G14 [get_ports {ddr3_cas_n}]

# PadFunction: IO_L12N_T1_MRCC_39 
set_property VCCAUX_IO NORMAL [get_ports {ddr3_we_n}]
set_property SLEW FAST [get_ports {ddr3_we_n}]
set_property IOSTANDARD SSTL15 [get_ports {ddr3_we_n}]
set_property PACKAGE_PIN G13 [get_ports {ddr3_we_n}]
...
set_property PACKAGE_PIN J12 [get_ports {ddr3_cke[0]}]

# PadFunction: IO_L16P_T2_39 
set_property VCCAUX_IO NORMAL [get_ports {ddr3_odt[0]}]
set_property SLEW FAST [get_ports {ddr3_odt[0]}]
set_property IOSTANDARD SSTL15 [get_ports {ddr3_odt[0]}]
set_property PACKAGE_PIN K15 [get_ports {ddr3_odt[0]}]
...
set_property PACKAGE_PIN K12 [get_ports {ddr3_cs_n[0]}]
...
set_property PACKAGE_PIN C19 [get_ports {ddr3_dm[1]}]
...
set_property VCCAUX_IO DONTCARE [get_ports {clk_ref_i}]
...
set_property PACKAGE_PIN A20 [get_ports {ddr3_dqs_p[1]}]
...
set_property PACKAGE_PIN A19 [get_ports {ddr3_dqs_n[1]}]
...
set_property LOC IN_FIFO_X1Y35 [get_cells  -hier -filter {NAME =~ */ddr_phy_4lanes_1.u_ddr_phy_4lanes/ddr_byte_lane_D.ddr_byte_lane_D/in_fifo_gen.in_fifo}]
...
set_property LOC OLOGIC_X1Y443 [get_cells  -hier -filter {NAME =~ */ddr_phy_4lanes_1.u_ddr_phy_4lanes/ddr_byte_lane_D.ddr_byte_lane_D/ddr_byte_group_io/*slave_ts}]
